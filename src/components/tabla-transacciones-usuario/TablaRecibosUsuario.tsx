...
export default function TablaRecibos() {
  ...
  const fetchData = async () => {
    try {
      const idUsuario = await apiUsuarios.getUserByEmail(localStorage.getItem('email') as string);
      const response = await apiTransacciones.getByUsuario(idUsuario.respuesta.id_usuarios);
